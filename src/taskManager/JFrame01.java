 ...
 * @author Даниил
 */
public class JFrame01 extends javax.swing.JFrame implements View {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Название", "Автор", "Дата", "Напомнить за:", "Статус"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JDialog01 frame2 = new JDialog01(this, true);
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        Controller.getInstance().Stop(); // TODO add your handling code here:
    ...
    public void update(Journal journal) {
        ...
        for (int i = 0; i < journal.getSize(); i++) {
            ...
            model.addRow(new Object[]{task.name, task.author, task.date, task.time});
