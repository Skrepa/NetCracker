 ...
 * @author Даниил
 */
public class JDialog01 extends javax.swing.JDialog {

    /**
     * Creates new form JDialog01
     */
    public JDialog01(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Controller.getInstance().add(textField1.getText(),textField2.getText(),dateTimePicker1.getDateTimeStrict(),timePicker1.getTime(),textArea1.getText());
    ...
    private boolean isFieldsFilled() {
        return textField1.getText().length() > 0 && textField2.getText().length() > 0 && textArea1.getText().length() > 0 && dateTimePicker1.getDateTimeStrict() != null;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialog01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialog01 dialog = new JDialog01(new javax.swing.JFrame(), true);
